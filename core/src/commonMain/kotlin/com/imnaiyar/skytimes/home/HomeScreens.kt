...
import com.imnaiyar.skytimes.di.LocalCoreContainer
...
import skytimes.core.generated.resources.calendar
import skytimes.core.generated.resources.clock_analogue
import skytimes.core.generated.resources.cogwheel
import skytimes.core.generated.resources.quest_icon
import skytimes.core.generated.resources.replay
import skytimes.core.generated.resources.shards_icon
...
enum class HomeScreens(
    ...
    Quests("Quests", Res.drawable.quest_icon, { _ ->
        val date = LocalCoreContainer.current.clockRepository.observeDate()
    ...
    Shards("Shards", Res.drawable.shards_icon, { tutorialTargetsEnabled ->
        val clockRepository = LocalCoreContainer.current.clockRepository
