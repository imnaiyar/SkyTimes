...
fun MainScreen(
    ...
    NavigationBackHandler(
        ...
        isBackEnabled = pagerState.currentPage != defaultScreenIndex && isOnMainRoute
    ) {
        scope.launch {
        ...
        HorizontalPager(
            ...
            Scaffold(
                ...
                when (screens[page]) {
                    ...
                    HomeScreens.Quests -> QuestsScreen(
