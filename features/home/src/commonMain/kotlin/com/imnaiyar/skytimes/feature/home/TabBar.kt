...
fun AppTab.topBarActions(reminderFlow: ReminderFlowController? = null): (@Composable RowScope.(Boolean) -> Unit)? =
    when (this) {
        AppTab.SkyTimes -> { _ ->
        ...
        AppTab.Shards -> { tutorialTargetsEnabled ->
            ...
            Row(
                ...
                reminderFlow?.let { flow ->
                    val reminders =
                        com.imnaiyar.skytimes.feature.reminders.LocalReminderRepository.current.reminders.collectAsState()
                ...
                TutorialTarget(
                    ...
                    Tooltip(dateDisclaimer, showOnClick = false) {
                        OutlinedButton(
                            ...
                            Icon(
                                painterResource(CoreRes.drawable.calendar),
